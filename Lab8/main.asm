...
.equ EnableMask = 0b11111111 ; binary number to represent EnableMask when we want interrupts
.equ DisableMask = 0b00000000; binary number to disable Mask when we dont want inerrupts
